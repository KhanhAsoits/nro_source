...
public class BossID {
    ...
    public static final int AN_TROM = -213;
    public static final int BUBBLES = -2;
    public static final int CA_DIC = -3;
    ...
    public static final int SUPER_BROLY_HUYEN_THOAI = -209;
    public static final int SUPER_BROLY_HUYEN_THOAI_2 = -210;
