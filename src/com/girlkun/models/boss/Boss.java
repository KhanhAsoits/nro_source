...
//    protected void maxpow() {
//        ServerNotify.gI().notify("BOSS " + this.name + " vừa làm 1 cú dame " + this
//                );
//    }
...
//        Service.getInstance().dropItemMap(this.zone, new ItemMap(this.zone, Util.nextInt(1000), 1,
